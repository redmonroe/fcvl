...
class GoogleApiCalls:
    ...
    def simple_batch_update(self, service, sheet_id, wrange, data, dim):
        ...
        request = service.spreadsheets().values().batchUpdate(
            spreadsheetId=sheet_id, body=body_request)
        response = request.execute()
        print(
            f'Updating {[*response.values()][5][0]["updatedRange"]}, changing {[*response.values()][5][0]["updatedCells"]} cells.')
    ...
    def format_row(self, service, sheet_id, write_range, r_or_c, name_list):
        ...
        request = service.spreadsheets().values().update(spreadsheetId=sheet_id,
                                                         range=write_range, valueInputOption=value_input_option, body=value_range_body)
        response = request.execute()
    ...
    def date_stamp(self, service, sheet_id, wrange):
        ...
        request = service.spreadsheets().values().update(spreadsheetId=sheet_id,
                                                         range=wrange, valueInputOption=value_input_option, body=value_range_body)
        response = request.execute()
