class Persistent:
    ...
    changes = [{'obj_type': 'Payment', 'action': 'delete', 'col_name1': ('tenant_id', 'newcomb, benny'), 'col_name2': ('amount', '476.0'), 'col_name3': ('date_posted', '2022-02-08')}, 
        ...
        {'obj_type': 'Findexer', 'action': 'update_findexer', 'col_name1': ('tenant_id', 'hawkins, norland'), 'col_name2': ('amount', '314.00'), 'col_name3': ('date_posted', '2022-11-11'), 'col_name4': ('new_amount', '204.00')},
    ]
