class Persistent:
    ...
    changes = [{'obj_type': 'Payment', 
               ...
               {'obj_type': 'Subsidy', 'action': 'update_amount', 'col_name1': ('tenant_id', 'brown, alicia'), 'col_name2': (
                   'sub_amount', '1115.00'), 'col_name3': ('date_posted', '2022-09-01'), 'col_name4': ('new_amount', '224.00')},

               {'obj_type': 'TenantRent', 'action': 'update_amount', 'col_name1': ('t_name_id', 'brown, alicia'), 'col_name2': (
                   'rent_amount', '-345.00'), 'col_name3': ('rent_date', '2022-09-01'), 'col_name4': ('new_amount', '546.00')},

               {'obj_type': 'Subsidy', 'action': 'update_amount', 'col_name1': ('tenant_id', 'brown, alicia'), 'col_name2': (
                   'sub_amount', '-370.00'), 'col_name3': ('date_posted', '2022-10-01'), 'col_name4': ('new_amount', '224.00')},
               ...
               {'obj_type': 'Payment',
                'action': 'update_amount',
                'col_name1': ('tenant_id', 'hawkins, norland'), 
                'col_name2': ('amount', '314.00'), 
                'col_name3': ('date_posted', '2022-11-11'), 
                'col_name4': ('new_amount', '204.00')
                },

               {'obj_type': 'Findexer',
                'action': 'update_findexer',
                'col_name1': ('doc_id', 18),
                'col_name2': ('corr_sum', '-414.56'),
